...
void VE_TestComponent_System(VE_EntityHandleT entityHandle, void *pData) {
...
VE_TestComponent VE_NewTestComponent(int counter, int maxVal) {
	return (VE_TestComponent) { VE_TestComponentID, counter, maxVal };
}

void VE_TestComponentSpawner_System(VE_EntityHandleT entityHandle, void *pData) {
	VE_TestComponentSpawner *pSpawner = (VE_TestComponentSpawner *)pData;
	VE_EntityHandleT newEntity = VE_ECS_CreateEntity();
	VE_TestComponent component = VE_NewTestComponent(0, 100000);
	VE_ECS_InsertComponent(newEntity, &component);
}

VE_TestComponentSpawner VE_NewTestComponentSpawner() {
	return (VE_TestComponentSpawner) { VE_TestComponentSpawnerID };
}

void VE_Transform_System(VE_EntityHandleT entityHandle, void *pData) {
...
void VE_SetupBuiltinComponents() {
	...
	VE_TestComponentSpawnerID = VE_ECS_RegisterComponent("TestComponentSpawner", sizeof(VE_TestComponentSpawner), VE_TestComponentSpawner_System, NULL);
